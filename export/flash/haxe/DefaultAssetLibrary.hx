...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/Gnome1.png", __ASSET__assets_images_gnome1_png);
		type.set ("assets/images/Gnome1.png", AssetType.IMAGE);
		className.set ("assets/images/Grass.png", __ASSET__assets_images_grass_png);
		...
		className.set ("assets/images/StoreManager.png", __ASSET__assets_images_storemanager_png);
		type.set ("assets/images/StoreManager.png", AssetType.IMAGE);
		className.set ("assets/images/WindowBox.png", __ASSET__assets_images_windowbox_png);
		type.set ("assets/images/WindowBox.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/WindowBox.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_hvd_comic_serif_pro_otf extends flash.text.Font { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_gnome1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_grass_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_storemanager_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_windowbox_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_locales_en_gb_aui_csv extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_locales_en_gb_fonts_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_locales_en_gb_ui_txt extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_locales_es_es_fonts_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_locales_es_es_ui_csv extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_locales_famfamfam_flag_icons_zip extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_locales_index_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_locales_it_it_fonts_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_locales_it_it_ui_csv extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_locales_nl_nl_fonts_xml extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_locales_nl_nl_ui_csv extends flash.utils.ByteArray { }
...
@:image("assets/images/Gnome1.png") #if display private #end class __ASSET__assets_images_gnome1_png extends lime.graphics.Image {}
@:image("assets/images/Grass.png") #if display private #end class __ASSET__assets_images_grass_png extends lime.graphics.Image {}
...
@:image("assets/images/StoreManager.png") #if display private #end class __ASSET__assets_images_storemanager_png extends lime.graphics.Image {}
@:image("assets/images/WindowBox.png") #if display private #end class __ASSET__assets_images_windowbox_png extends lime.graphics.Image {}
