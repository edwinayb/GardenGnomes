...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Atilio", "GardenGnomes", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "GardenGnomes";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "GardenGnomes", null, { width: 1280, height: 720 });
