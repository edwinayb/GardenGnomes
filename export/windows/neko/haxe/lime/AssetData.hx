...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/2k15.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/exitbtn.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/store.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/trophy_p.png", Reflect.field (AssetType, "image".toUpperCase ()));
